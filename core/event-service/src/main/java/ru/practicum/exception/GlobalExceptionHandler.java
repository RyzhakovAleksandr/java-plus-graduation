...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotMeetRulesEdition(NotMeetRulesEditionException e) {
        log.error("Not meet rules: {}", e.getMessage());
        return ResponseEntity
                .status(HttpStatus.CONFLICT)
                .body(Map.of(
                        "error", "Conflict",
    ...
    public ResponseEntity<Map<String, Object>> handleMismatchDate(MismatchDateException e) {
        log.error("Date mismatch: {}", e.getMessage());
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(Map.of(
                        "error", "Bad request",
